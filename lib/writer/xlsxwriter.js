...
MZip.prototype.addFile = function(name,buffer) {
    ...
    f.file(p[p.length-1], buffer.toString());
    
    
}

MZip.prototype.writeZip = function(fn){
    var b64 = this.jszip.generate({ compression: 'DEFLATE' });
    fs.writeFileSync(fn, new Buffer(b64,'base64'));
}
