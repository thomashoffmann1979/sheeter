...
ContentReader.prototype.parse = function(callback){
    var me=this;
    sheeter_utils.xmlToJSON(this._data,function(err,data){
        ...
        if ( (typeof data.name != 'undefined' ) && (data.name == 'Types') ){
                    ...
                    if (
                        ...
                        switch(node.attributes.ContentType){
                            ...
                            case 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet.main+xml':
                                me.main.push(node.attributes.PartName);
                                break;
                        ...
                        callback(new Error('invalid [Content Types].xml'));
                        return;
                    }
                }
            ...
            callback(new Error('The given xml does not contain a types-element.'));
            return;
        }
        callback(null);
    });
